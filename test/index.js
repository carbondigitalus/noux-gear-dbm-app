...
describe('demo app', function() {
  ...
  it('opens a window displaying the about page', function() {
    return app.client
      ...
      .should.eventually.be.false.isVisible('.js-nav').should.eventually.be
      .true;
  });
  ...
  describe('when clicking on a section from the nav bar', function() {
    it('it shows the selected section in the main area', function() {
      return app.client
        ...
        .should.eventually.be.false.isExisting(
          'button.is-selected[data-section="windows"]'
        )
        .should.eventually.be.false.isExisting(
          'button.is-selected[data-section="menus"]'
  ...
  describe('when a demo title is clicked', function() {
    it('it expands the demo content', function() {
      const onlyFirstVisible = Array(30).fill(false);
